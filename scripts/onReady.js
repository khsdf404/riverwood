...
const START_AREA = SearchArea.AREATYPES.region;
...
const RegionEnum = {
    ...
    'OCEANIA':   [
        ...
        {'id': '16', 'en': 'American Samoa', 'ru': 'Американское Самоа'},
        {'id': '28', 'en': 'Antigua and Barbuda', 'ru': 'Антигуа и Барбуда'},
        {'id': '44', 'en': 'Bahamas', 'ru': 'Багамские Острова'},
        {'id': '52', 'en': 'Barbados', 'ru': 'Барбадос'},
        {'id': '60', 'en': 'Bermuda', 'ru': 'Бермудские Острова'},
        {'id': '74', 'en': 'Bouvet Island', 'ru': 'Остров Буве'},
        {'id': '86', 'en': 'British Indian Ocean Territory', 'ru': 'Британская территория в Индийском океане'},
        {'id': '90', 'en': 'Solomon Islands', 'ru': 'Соломоновы Острова'},
        {'id': '92', 'en': 'Virgin Islands', 'ru': 'Виргинские Острова'},
        {'id': '136', 'en': 'Cayman Islands', 'ru': 'Острова Кайман'},
        {'id': '162', 'en': 'Christmas Island', 'ru': 'Остров Рождества'},
        {'id': '166', 'en': 'Cocos (Keeling) Islands', 'ru': 'Кокосовые острова'},
        {'id': '175', 'en': 'Mayotte', 'ru': 'Майотта'},
        {'id': '184', 'en': 'Cook Islands', 'ru': 'Острова Кука'},
        {'id': '192', 'en': 'Cuba', 'ru': 'Куба'},
        {'id': '212', 'en': 'Dominica', 'ru': 'Доминика'},
        {'id': '214', 'en': 'Dominican Republic', 'ru': 'Доминиканская Республика'},
        {'id': '234', 'en': 'Faroe Islands', 'ru': 'Фарерские острова'},
        {'id': '238', 'en': 'Falkland Islands', 'ru': 'Фолклендские острова'},
        {'id': '239', 'en': 'South Georgia and the South Sandwich Islands', 'ru': 'Южная Георгия и Южные Сандвичевы Острова'},
        {'id': '242', 'en': 'Fiji', 'ru': 'Фиджи'},
        {'id': '248', 'en': 'Aland Islands', 'ru': 'Аландские острова'},
        {'id': '258', 'en': 'French Polynesia', 'ru': 'Полинезия'},
        ...
        {'id': '292', 'en': 'Gibraltar', 'ru': 'Гибралтар'},
        {'id': '296', 'en': 'Kiribati', 'ru': 'Кирибати'},
        {'id': '304', 'en': 'Greenland', 'ru': 'Гренландия'},
        {'id': '308', 'en': 'Grenada', 'ru': 'Гренада'},
        {'id': '312', 'en': 'Guadeloupe', 'ru': 'Гваделупа'},
        {'id': '316', 'en': 'Guam', 'ru': 'Гуам'},
        {'id': '332', 'en': 'Haiti', 'ru': 'Гаити'},
        {'id': '334', 'en': 'Heard Island and McDonald Islands', 'ru': 'Остров Херд и острова Макдональд'},
        {'id': '336', 'en': 'Vatican City', 'ru': 'Ватикан'},
        {'id': '344', 'en': 'Hong Kong', 'ru': 'Гонконг'},
        {'id': '388', 'en': 'Jamaica', 'ru': 'Ямайка'},
        {'id': '446', 'en': 'Macao', 'ru': 'Макао'},
        {'id': '450', 'en': 'Madagascar', 'ru': 'Мадагаскар'},
        {'id': '470', 'en': 'Malta', 'ru': 'Мальта'},
        {'id': '474', 'en': 'Martinique', 'ru': 'Мартиника'},    
        {'id': '500', 'en': 'Montserrat', 'ru': 'Монтсеррат'},
        {'id': '520', 'en': 'Nauru', 'ru': 'Науру'},
        {'id': '531', 'en': 'Curaçao', 'ru': 'Кюрасао'},
        {'id': '533', 'en': 'Aruba', 'ru': 'Аруба'},
        {'id': '534', 'en': 'Sint Maarten', 'ru': 'Синт-Мартен'},
        {'id': '535', 'en': 'Bonaire, Sint Eustatius and Saba', 'ru': 'Бонайре'},
        {'id': '540', 'en': 'New Caledonia', 'ru': 'Новая Каледония'},
        {'id': '548', 'en': 'Vanuatu', 'ru': 'Вануату'},
        {'id': '554', 'en': 'New Zealand', 'ru': 'Новая Зеландия'},
        {'id': '570', 'en': 'Niue', 'ru': 'Ниуэ'},
        {'id': '574', 'en': 'Norfolk Island', 'ru': 'Норфолк'},
        {'id': '580', 'en': 'Northern Mariana Islands', 'ru': 'Северные Марианские острова'},
        {'id': '581', 'en': 'United States Minor Outlying Islands', 'ru': 'Внешние малые острова США'},
        {'id': '583', 'en': 'Micronesia', 'ru': 'Микронезия'},
        {'id': '584', 'en': 'Marshall Islands', 'ru': 'Маршалловы Острова'},
        {'id': '585', 'en': 'Palau', 'ru': 'Палау'},
        {'id': '598', 'en': 'Papua New Guinea', 'ru': 'Папуа – Новая Гвинея'},
        {'id': '612', 'en': 'Pitcairn', 'ru': 'Острова Питкэрн'},
        {'id': '630', 'en': 'Puerto Rico', 'ru': 'Пуэрто-Рико'},
        {'id': '638', 'en': 'Réunion', 'ru': 'Реюньон'},
        {'id': '652', 'en': 'Saint Barthélemy', 'ru': 'Сен-Бартелеми'},
        {'id': '654', 'en': 'Saint Helena, Ascension and Tristan da Cunha', 'ru': 'Острова Святой Елены'},
        {'id': '659', 'en': 'Saint Kitts and Nevis', 'ru': 'Сент-Китс и Невис'},
        {'id': '660', 'en': 'Anguilla', 'ru': 'Ангилья'},
        {'id': '662', 'en': 'Saint Lucia', 'ru': 'Сент-Люсия'},
        {'id': '663', 'en': 'Saint Martin', 'ru': 'Сен-Мартен'},
        {'id': '666', 'en': 'Saint Pierre and Miquelon', 'ru': 'Сен-Пьер и Микелон'},
        {'id': '670', 'en': 'Saint Vincent and the Grenadines', 'ru': 'Сент-Винсент и Гренадины'},
        {'id': '674', 'en': 'San Marino', 'ru': 'Сан Марино'},
        {'id': '744', 'en': 'Svalbard and Jan Mayen', 'ru': 'Шпицберген и Ян-Майен'},
        {'id': '772', 'en': 'Tokelau', 'ru': 'Токелау'},
        {'id': '776', 'en': 'Tonga', 'ru': 'Тонга'},
        {'id': '780', 'en': 'Trinidad and Tobago', 'ru': 'Тринидад и Тобаго'},
        {'id': '796', 'en': 'Turks and Caicos Islands', 'ru': 'Теркс и Кайкос'},
        {'id': '798', 'en': 'Tuvalu', 'ru': 'Тувалу'},
        {'id': '831', 'en': 'Guernsey', 'ru': 'Гернси'},
        {'id': '832', 'en': 'Jersey', 'ru': 'Джерси'},
        {'id': '833', 'en': 'Isle of Man', 'ru': 'Остров Мэн'},
        {'id': '850', 'en': 'Virgin Islands', 'ru': 'Виргинские Острова'},
        {'id': '876', 'en': 'Wallis and Futuna', 'ru': 'Уоллис и Футуна'},
...
const COUNTRIES = [
    ...
    {'id': '854', 'en': 'Burkina Faso', 'ru': 'Буркина Фасо'},
    {'id': '894', 'en': 'Zambia', 'ru': 'Забмия'}, 
    {'id': '900', 'en': 'Somalia', 'ru': 'Сомали'}, // changed need to concat it in json
...
{'id': '124', 'en': 'Canada', 'ru': 'Канада'},
    ...
    {'id': '858', 'en': 'Uruguay', 'ru': 'Уругвай'},
    {'id': '862', 'en': 'Venezuela', 'ru': 'Венесуэла'},
    {'id': '904', 'en': 'French Guiana', 'ru': 'Гвиана'}, // changed France & South America
    ...
    {'id': '608', 'en': 'Philippines', 'ru': 'Филиппины'},
    {'id': '634', 'en': 'Qatar', 'ru': 'Катар'},
    {'id': '643', 'en': 'Russian Federation', 'ru': 'Россия'}, // changed europe + asia
    {'id': '682', 'en': 'Saudi Arabia', 'ru': 'Саудовская Аравия'},
    {'id': '702', 'en': 'Singapore', 'ru': 'Сингапур'},
    {'id': '704', 'en': 'Vietnam', 'ru': 'Вьетнам'},
    {'id': '760', 'en': 'Syria', 'ru': 'Сирия'},
    ...
    {'id': '752', 'en': 'Sweden', 'ru': 'Швеция'},
    {'id': '756', 'en': 'Switzerland', 'ru': 'Швейцария'},
    {'id': '804', 'en': 'Ukraine', 'ru': 'Украина'}, // changed get крым 
    {'id': '807', 'en': 'Macedonia', 'ru': 'Македония'},
    {'id': '826', 'en': 'United Kingdom', 'ru': 'Англия'},
    {'id': '901', 'en': 'Kosovo', 'ru': 'Косово'},
    ...
    {'id': '10', 'en': 'Antarctica', 'ru': 'Антарктика'}, // changed +mainland
    {'id': '16', 'en': 'American Samoa', 'ru': 'Американское Самоа'}, // changed USA & Oceania
    {'id': '28', 'en': 'Antigua and Barbuda', 'ru': 'Антигуа и Барбуда'},
    {'id': '44', 'en': 'Bahamas', 'ru': 'Багамские Острова'}, 
    {'id': '52', 'en': 'Barbados', 'ru': 'Барбадос'}, 
    {'id': '60', 'en': 'Bermuda', 'ru': 'Бермудские Острова'}, // changed Britain and Oceania
    {'id': '74', 'en': 'Bouvet Island', 'ru': 'Остров Буве'}, 
    {'id': '86', 'en': 'British Indian Ocean Territory', 'ru': 'Британская территория в Индийском океане'}, // changed Britain & Oceania
    {'id': '90', 'en': 'Solomon Islands', 'ru': 'Соломоновы Острова'}, 
    {'id': '92', 'en': 'Virgin Islands', 'ru': 'Виргинские Острова'}, // changed Britain
    {'id': '136', 'en': 'Cayman Islands', 'ru': 'Острова Кайман'}, // changed Britain
    {'id': '162', 'en': 'Christmas Island', 'ru': 'Остров Рождества'}, // changed Australia country
    {'id': '166', 'en': 'Cocos (Keeling) Islands', 'ru': 'Кокосовые острова'}, // changed Australia ???
    {'id': '175', 'en': 'Mayotte', 'ru': 'Майотта'}, // changed France
    {'id': '184', 'en': 'Cook Islands', 'ru': 'Острова Кука'}, 
    {'id': '192', 'en': 'Cuba', 'ru': 'Куба'},
    {'id': '212', 'en': 'Dominica', 'ru': 'Доминика'},
    {'id': '214', 'en': 'Dominican Republic', 'ru': 'Доминиканская Республика'},
    {'id': '234', 'en': 'Faroe Islands', 'ru': 'Фарерские острова'}, // changed Denmark & Oceania
    {'id': '238', 'en': 'Falkland Islands', 'ru': 'Фолклендские острова'}, // changed Britain & Oceania
    {'id': '239', 'en': 'South Georgia and the South Sandwich Islands', 'ru': 'Южная Георгия и Южные Сандвичевы Острова'}, // changed Britain & Oceania
    {'id': '242', 'en': 'Fiji', 'ru': 'Фиджи'}, 
    {'id': '248', 'en': 'Aland Islands', 'ru': 'Аландские острова'}, // changed Finland
    {'id': '258', 'en': 'French Polynesia', 'ru': 'Полинезия'}, // changed France & Oceania
    {'id': '260', 'en': 'French Southern Territories', 'ru': 'Французские Южные и Антарктические территории'}, // changed France & Oceania
    {'id': '275', 'en': 'Palestinian Territory', 'ru': 'Палестинские территории'}, // changed why is it here?
    {'id': '292', 'en': 'Gibraltar', 'ru': 'Гибралтар'}, // change France add to JSON 
    {'id': '296', 'en': 'Kiribati', 'ru': 'Кирибати'},
    {'id': '304', 'en': 'Greenland', 'ru': 'Гренландия'}, // change Denmark & Oceania
    {'id': '308', 'en': 'Grenada', 'ru': 'Гренада'},
    {'id': '312', 'en': 'Guadeloupe', 'ru': 'Гваделупа'}, // change France & Oceania
    {'id': '316', 'en': 'Guam', 'ru': 'Гуам'}, // change USA & Oceania
    {'id': '332', 'en': 'Haiti', 'ru': 'Гаити'}, 
    {'id': '334', 'en': 'Heard Island and McDonald Islands', 'ru': 'Остров Херд и острова Макдональд'}, // changed Australia & Oceania
    {'id': '336', 'en': 'Vatican City', 'ru': 'Ватикан'}, // changed wtf it is europe
    {'id': '344', 'en': 'Hong Kong', 'ru': 'Гонконг'}, // changed wtf it is europe
    {'id': '388', 'en': 'Jamaica', 'ru': 'Ямайка'}, 
    {'id': '446', 'en': 'Macao', 'ru': 'Макао'}, // changed wtf it is europe
    {'id': '450', 'en': 'Madagascar', 'ru': 'Мадагаскар'}, // changed Africa
    {'id': '470', 'en': 'Malta', 'ru': 'Мальта'},
    {'id': '474', 'en': 'Martinique', 'ru': 'Мартиника'}, // changed France & Oceania
    {'id': '500', 'en': 'Montserrat', 'ru': 'Монтсеррат'}, // changed Britain & Oceania
    {'id': '520', 'en': 'Nauru', 'ru': 'Науру'}, 
    {'id': '531', 'en': 'Curaçao', 'ru': 'Кюрасао'},
    {'id': '533', 'en': 'Aruba', 'ru': 'Аруба'},
    {'id': '534', 'en': 'Sint Maarten', 'ru': 'Синт-Мартен'}, // changed Nitherlands & Oceania
    {'id': '535', 'en': 'Bonaire, Sint Eustatius and Saba', 'ru': 'Бонайре'}, // changed Nitherlands & Oceania
    {'id': '540', 'en': 'New Caledonia', 'ru': 'Новая Каледония'}, 
    {'id': '548', 'en': 'Vanuatu', 'ru': 'Вануату'},
    {'id': '554', 'en': 'New Zealand', 'ru': 'Новая Зеландия'},
    {'id': '570', 'en': 'Niue', 'ru': 'Ниуэ'},
    {'id': '574', 'en': 'Norfolk Island', 'ru': 'Норфолк'}, // changed add to Britain JSON
    {'id': '580', 'en': 'Northern Mariana Islands', 'ru': 'Северные Марианские острова'}, // changed USA & Oceania 
    {'id': '581', 'en': 'United States Minor Outlying Islands', 'ru': 'Внешние малые острова США'}, // changed USA & Oceania
    {'id': '583', 'en': 'Micronesia', 'ru': 'Микронезия'}, // changed idk google it
    {'id': '584', 'en': 'Marshall Islands', 'ru': 'Маршалловы Острова'}, // changed USA & Oceania
    {'id': '585', 'en': 'Palau', 'ru': 'Палау'}, // changed USA & Oceania
    {'id': '598', 'en': 'Papua New Guinea', 'ru': 'Папуа – Новая Гвинея'}, 
    {'id': '612', 'en': 'Pitcairn', 'ru': 'Острова Питкэрн'}, // changed Britain & Oceania
    {'id': '630', 'en': 'Puerto Rico', 'ru': 'Пуэрто-Рико'},
    {'id': '638', 'en': 'Réunion', 'ru': 'Реюньон'}, // changed France & Oceania
    {'id': '652', 'en': 'Saint Barthélemy', 'ru': 'Сен-Бартелеми'}, // changed France & Oceania
    {'id': '654', 'en': 'Saint Helena, Ascension and Tristan da Cunha', 'ru': 'Острова Святой Елены'}, // changed Britain & Oceania 
    {'id': '659', 'en': 'Saint Kitts and Nevis', 'ru': 'Сент-Китс и Невис'}, 
    {'id': '660', 'en': 'Anguilla', 'ru': 'Ангилья'}, // changed Britain & Oceania
    {'id': '662', 'en': 'Saint Lucia', 'ru': 'Сент-Люсия'}, 
    {'id': '663', 'en': 'Saint Martin', 'ru': 'Сен-Мартен'}, // changed France & Oceania
    {'id': '666', 'en': 'Saint Pierre and Miquelon', 'ru': 'Сен-Пьер и Микелон'}, // changed France & Oceania
    {'id': '670', 'en': 'Saint Vincent and the Grenadines', 'ru': 'Сент-Винсент и Гренадины'}, 
    {'id': '674', 'en': 'San Marino', 'ru': 'Сан Марино'}, 
    {'id': '744', 'en': 'Svalbard and Jan Mayen', 'ru': 'Шпицберген и Ян-Майен'}, // changed Norway & Oceania
    {'id': '772', 'en': 'Tokelau', 'ru': 'Токелау'}, 
    {'id': '776', 'en': 'Tonga', 'ru': 'Тонга'},
    {'id': '780', 'en': 'Trinidad and Tobago', 'ru': 'Тринидад и Тобаго'},
    {'id': '796', 'en': 'Turks and Caicos Islands', 'ru': 'Теркс и Кайкос'}, // changed Britain & Oceania
    {'id': '798', 'en': 'Tuvalu', 'ru': 'Тувалу'}, 
    {'id': '831', 'en': 'Guernsey', 'ru': 'Гернси'},
    {'id': '832', 'en': 'Jersey', 'ru': 'Джерси'},
    {'id': '833', 'en': 'Isle of Man', 'ru': 'Остров Мэн'}, 
    {'id': '850', 'en': 'Virgin Islands', 'ru': 'Виргинские Острова'}, // changed Britain & Oceania 
    {'id': '876', 'en': 'Wallis and Futuna', 'ru': 'Уоллис и Футуна'}, // changed France & Oceania
    {'id': '882', 'en': 'Samoa', 'ru': 'Самоа'}, 
]
const REGIONS = [
    {
