...
class LanguagesObj {
    ...
    static TEXT = {
        'ru': [
            ...
            // contacts
            'Реки по всему миру',
            'Этот проект задумывался как билиотека всех рек на нашей планете, он c <a href="https://github.com/khsdf404/Coursework_3-Frontend-">открытым кодом</a> и бесплатен для всех. Пожалуйста, если вы носитель английского, французского или испанского и хотите помочь с переводом страницы, проследуйте по ссылкам снизу или пришлите мне письмо на почту, начав с «Помощь в переводе»',
        ...
        'en': [
            ...
            'This project was conceived as a library of all rivers on our planet, it\'s <a href="https://github.com/khsdf404/Coursework_3-Frontend-">opensourse</a> and free for everyone. Please, if you are a native speaker of English, French or Spanish and want to help with page translation follow links below or sent me en email, starting with "Translation help"',
            'Coursework info',
            'Student: Orlov Danil',
        ...
        'fr': [
            ...
            'Ce projet a ete concu comme une bibliotheque de tous les fleuves de notre planete, il est <a href="https://github.com/khsdf404/Coursework_3-Frontend-">opensource</a> et gratuit pour tous. S\'il vous plait, si vous etes anglais, francais ou espagnol et que vous voulez aider a la traduction de la page, suivez les liens ci-dessous ou envoyez-moi un e-mail en commencant par «Aide a la traduction»',
            'Redige  info',
        ...
        'sp': [
            ...
            'Este proyecto fue concebido como una biblioteca de todos los rios de nuestro planeta, es de <a href="https://github.com/khsdf404/Coursework_3-Frontend-">codigo abierto</a> y gratuito para todos. Por favor, si usted es un hablante nativo de Ingles, frances o espanol y desea ayudar con la traduccion de la pagina, siga los enlaces de abajo o enveeme un email, comenzando con «Ayuda en la traduccion»',
            'Cursos info',
